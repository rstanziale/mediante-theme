	...
	<div class="row justify-content-center">
		<div class="col-md-8 col-sm-12">
			<?php if (have_posts()) : while (have_posts()) : the_post(); ?>
					...
					<?php } ?>
					<article>
						<h1 class="fw-bold text-center text-primary"><?php the_title(); ?> / Servizi</h1>
						...
						<div class="d-flex my-3">
							<span>
								...
								foreach ($tags as $tag) {
									echo ('<a href="' . get_tag_link($tag->term_id) . '" class="badge badge-pill badge-primary me-1 rel="tag"><i class="fas fa-tag me-1"></i>' . $tag->name . "</a>");
								}
								?>
							</span>
